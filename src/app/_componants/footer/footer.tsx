  ...
  return (
    <footer className="bg-gray-100 py-12 px-4 mt-20 border-t border-gray-200">
      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-primary">Get The FreshCart App</h2>
          <p className="text-gray-500 mt-1">We will send you a link, Open it in your phone to download App</p>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 py-6 border-y border-gray-200">
          ...
          <div className="flex items-center gap-4">
            <span className="font-semibold text-gray-700">Payment Partners</span>
            <div className="flex items-center gap-4 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
               ...
               <img src="https://upload.wikimedia.org/wikipedia/commons/b/b7/MasterCard_Logo.png" alt="Amex" className="h-6" />
            </div>
          </div>


          <div className="flex items-center gap-4">
            <span className="font-semibold text-gray-700">Get deliveries with FreshCart</span>
        ...
        <div className="mt-10 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
          ...
          <p>Designed by <span className="text-primary font-bold">Mohamed Ramadan saaed</span></p>
        </div>
      </div>
    </footer>
  );
