  ...
  return (
    <nav className="py-4 bg-[#f8f9fa] border-b border-gray-200">
      <div className="max-w-screen-xl mx-auto px-4 flex items-center gap-2 text-[15px]">
        <Link href="/" className="text-primary font-medium hover:text-green-700 transition-colors">
          Home
        </Link>
        ...
        {pathNodes.map((node, index) => {
          ...
          const label = (isLast && dynamicTitle) ? dynamicTitle : (routeLabels[nodeLower] || node);
