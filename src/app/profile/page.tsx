...
export default function ProfilePage() {
  ...
  const currentUser = {
    ...
    email: session?.user?.email || "midoramadan@gmail.com",
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-3xl shadow-sm p-8 text-center border border-gray-100">
              <div className="relative w-32 h-32 mx-auto mb-6">
                <div className="w-full h-full rounded-full bg-green-50 flex items-center justify-center text-primary text-4xl font-bold border-2 border-primary">
                  {currentUser.name.charAt(0).toUpperCase()}
                </div>
                <button className="absolute bottom-1 right-1 bg-white p-2 rounded-full shadow-md border border-gray-100 hover:text-primary transition-colors">
                  <Settings size={18} />
                </button>
              </div>
              ...
              <div className="flex justify-around border-t border-gray-50 pt-6">
                ...
                >
                  <div className="p-3 rounded-2xl group-hover:bg-green-50 transition-colors">
                    <ShoppingBag className="text-gray-400 group-hover:text-primary" />
                  </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-3xl shadow-sm p-8 border border-gray-100">
              <div className="flex justify-between items-center mb-8">
                ...
                <button className="text-primary text-sm font-bold hover:underline uppercase tracking-wider transition-all">
                  Edit Details
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link href="/change-password" title="Change Password">
                  <button className="w-full h-full text-left p-5 border border-gray-50 rounded-2xl bg-[#f8f9fa] hover:bg-white hover:shadow-md transition-all group">
                    <p className="text-sm font-bold cursor-pointer text-gray-800 group-hover:text-primary">
                      Change Password
                    </p>
