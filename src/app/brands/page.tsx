...
export default async function Brands() {
  ...
  if (!response.ok) {
    return (
      <div className="p-10 text-center">
        <h2 className="text-red-600 font-bold">Sorry, an error occurred while loading the data.</h2>
  ...
  if (!allBrands || allBrands.length === 0) {
    return (
      <div className="p-10 text-center">
        <p className="text-gray-500 italic">No brands available at the moment.</p>
      </div>
    );
  }
  ...
  return (
    <div className='container mx-auto my-10 px-4'>
      ...
      <div className="flex items-center justify-between mb-8 pb-4 ">
        <div>
          <h2 className='text-3xl font-extrabold text-primary text-main uppercase tracking-wider'>Popular Brands</h2>
