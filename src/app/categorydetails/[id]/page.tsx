      ...
      <div className="container mx-auto py-12 px-4">
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/3 flex justify-center border-r border-gray-100 pr-0 md:pr-10">
             <img src={category.image} alt={category.name} className="max-h-64 object-contain" />
          </div>
          ...
          <div className="w-full md:w-2/3 space-y-4 text-center md:text-left">
            ...
            <p className="text-gray-400 font-mono tracking-widest uppercase text-xs">SLUG: {category.slug}</p>
            
            <div className="h-[1px] bg-gray-100 w-full my-6"></div>
            
            <p className="text-gray-600 text-lg leading-relaxed max-w-2xl">
              This category features a wide range of premium products. You can find all products related to 
              <span className="font-bold text-gray-800 px-1">{category.name}</span> in our store.
            </p>
          </div>
        </div>
      </div>
